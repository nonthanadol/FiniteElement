...
R1 = open('bar_input_node_data.txt')
text = R1.readline()
inode, xc, c1, c2, c3 = [],[],[],[],[]
...
R2 = open("bar_input_element_data.txt")
text = R2.readline()
iele, n1, n2, A, E = [],[],[],[],[]
...
W1 = open('bar_output_node_solution.txt','w')
...
def cal_element(nele,n1,n2,u,xc,A,E):
    for j in range(nele):
        i1, i2, kele = K_element(j,nele,n1,n2,xc,A,E)
        uele = [u[i1],u[i2]]
...
f = cal_element(nele,n1,n2,u,xc,A,E)
...
W2 = open('bar_output_element_solution.txt','w')
